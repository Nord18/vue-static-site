<template>
  <div class="requirements">
    <h2 class="requirements__title">General requirements for the test task</h2>
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-sm-12 col-md-6 col-xl-5 requirements__content">
          <p class="requirements__descr">Users want to find answers to their questions quickly and data shows that people really care about how quickly their pages load. The Search team announced speed would be a ranking signal for desktop searches in 2010 and as of this month (July 2018), page speed will be a ranking factor for mobile searches too.</p>
          <p class="requirements__descr requirements__descr--center">If you're a developer working on a site, now is a good time to evaluate your performance using our speed tools. Think about how performance affects the user experience of your pages and consider measuring a variety of real-world user-centric performance metrics.</p>
          <p class="requirements__descr">Are you shipping too much JavaScript? Too many images? Images and JavaScript are the most significant contributors to the page weight that affect page load time based on data from HTTP Archive and the Chrome User Experience Report - our public dataset for key UX metrics as experienced by Chrome users under real-world conditions.</p>
        </div>
        <div class="col-sm-12 col-md-6 col-xl-4 requirements__inner">
          <svg class="requirements__pic" viewBox="0 0 429 362">
            <defs>
            ...
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="man-laptop-v1">
                    ...
                    <g id="_Group_2" transform="translate(179.000000, 53.000000)">
                        ...
                        <path d="M25.85,89.41 C25.8540444,92.6920053 23.8795902,95.6529052 20.8481848,96.9107432 C17.8167794,98.1685812 14.3261001,97.4753598 12.0053702,95.1546298 C9.68464019,92.8338999 8.99141878,89.3432206 10.2492568,86.3118152 C11.5070948,83.2804098 14.4679947,81.3059556 17.75,81.31 C22.2212222,81.3155098 25.8444902,84.9387778 25.85,89.41 Z" id="_Path_20" fill="#191919"></path>
                        <path d="M29.5,103.82 C29.5055076,108.292197 25.8855198,111.922611 21.4133251,111.929964 C16.9411303,111.937318 13.3092231,108.318829 13.3000233,103.846638 C13.2908235,99.3744465 16.9078129,95.7410459 21.38,95.73 C23.5246807,95.7246897 25.5834852,96.5722555 27.1028191,98.0859622 C28.622153,99.599669 29.4773523,101.655314 29.48,103.8 L29.5,103.82 Z" id="_Path_21" fill="#191919"></path>
                        <path d="M38.8,112.72 C38.8,117.193506 35.1735065,120.82 30.7,120.82 C26.2264935,120.82 22.6,117.193506 22.6,112.72 C22.6,108.246494 26.2264935,104.62 30.7,104.62 C32.8490673,104.617342 34.9108788,105.469879 36.4305,106.9895 C37.9501213,108.509121 38.8026581,110.570933 38.8,112.72 Z" id="_Path_22" fill="#191919"></path>
                        <path d="M54.27,111.91 C54.2506997,116.354541 50.6371479,119.944631 46.192576,119.934981 C41.748004,119.925331 38.150076,116.319582 38.150076,111.875 C38.150076,107.430418 41.748004,103.824669 46.192576,103.815019 C50.6371479,103.805369 54.2506997,107.395459 54.27,111.84 L54.27,111.91 Z" id="_Path_23" fill="#191919"></path>
                        <path d="M69.52,114.85 C69.5240444,118.132005 67.5495902,121.092905 64.5181848,122.350743 C61.4867794,123.608581 57.9961001,122.91536 55.6753702,120.59463 C53.3546402,118.2739 52.6614188,114.783221 53.9192568,111.751815 C55.1770948,108.72041 58.1379947,106.745956 61.42,106.75 C65.8935065,106.75 69.52,110.376494 69.52,114.85 Z" id="_Path_24" fill="#191919"></path>
                        <path d="M84.83,110.09 C84.8742484,113.370676 82.9374446,116.354815 79.9230829,117.650353 C76.9087211,118.945891 73.4107264,118.297567 71.0608685,116.007815 C68.7110106,113.718063 67.9722862,110.238038 69.1893008,107.191126 C70.4063153,104.144214 73.3392783,102.130754 76.62,102.09 L76.73,102.09 C81.1647433,102.089662 84.7752501,105.655595 84.83,110.09 Z" id="_Path_25" fill="#191919"></path>
                        <circle id="_Path_26" fill="#191919" cx="84.17" cy="98.66" r="8.1"></circle>
                        <path d="M97,84.39 C97.0040444,87.6720053 95.0295902,90.6329052 91.9981848,91.8907432 C88.9667794,93.1485812 85.4761001,92.4553598 83.1553702,90.1346298 C80.8346402,87.8138999 80.1414188,84.3232206 81.3992568,81.2918152 C82.6570948,78.2604098 85.6179947,76.2859556 88.9,76.29 C93.3640813,76.2899966 96.984482,79.9059221 96.99,84.37 L97,84.39 Z" id="_Path_27" fill="#191919"></path>
                        <path d="M95.93,70.54 C95.9299975,73.8210983 93.9529757,76.7789292 90.9212485,78.033615 C87.8895213,79.2883007 84.4004825,78.5926087 82.0818274,76.271091 C79.7631722,73.9495734 79.0717856,70.4596788 80.3302109,67.429502 C81.5886362,64.3993252 84.5489042,62.4259543 87.83,62.43 C92.3051236,62.435518 95.9300034,66.064873 95.93,70.54 Z" id="_Path_28" fill="#191919"></path>
                        <path d="M96.33,60.74 C96.6341041,65.2131906 93.2551949,69.0863103 88.7821039,69.3918763 C84.3090129,69.6974424 80.4347891,66.3197993 80.127761,61.8468084 C79.820733,57.3738175 83.1971097,53.49849 87.67,53.19 L88.24,53.19 C92.5615203,53.0439322 96.1833648,56.428499 96.33,60.75 L96.33,60.74 Z" id="_Path_29" fill="#191919"></path>
                    </g>
                    <g id="_Group_6" transform="translate(134.000000, 180.000000)">
                        ...
                        <path d="M103.23,61.93 C103.238089,66.7076004 100.366891,71.0194536 95.9556722,72.8543037 C91.5444528,74.6891537 86.462272,73.6855143 83.0797037,70.3115312 C79.6971353,66.937548 78.6805838,61.8579342 80.5042178,57.4420662 C82.3278517,53.0261982 86.6323945,50.1440522 91.41,50.14 C94.5420971,50.1320303 97.5486425,51.3706682 99.7661891,53.5825865 C101.983736,55.7945048 103.23001,58.7978928 103.23,61.93 Z" id="_Path_32" fill="#FFFFFF"></path>
                        <path d="M3.94,4.14 L180.24,118.43 C181.456071,116.698338 182.234914,114.69805 182.51,112.6 L182.51,11.85 C182.304079,9.32288993 181.358008,6.91249599 179.79,4.92 C177.928545,2.7222188 175.315466,1.29625493 172.46,0.92 C171.592819,0.833460352 170.721388,0.796733366 169.85,0.81 L12.08,0.81 C9.96357689,0.855019342 7.89549951,1.45131499 6.08,2.54 C5.33626348,3.03141227 4.62172468,3.56564689 3.94,4.14 Z" id="_Path_33" fill="#F5F5F5" opacity="0.57"></path>
                    </g>
                    <path d="M300.61,331.85 C298.400703,341.776186 295.180568,351.449994 291,360.72 C291,360.72 250.05,366.47 193.7,345.44 C193.7,345.44 167.38,334.03 163.79,331.85 L300.61,331.85 Z" id="_Path_34" fill="#191919"></path>
                    <path d="M305.8,331.85 L305.06,337.62 C304.831088,339.431284 303.182645,340.717873 301.37,340.5 L301.23,340.5 C291.48,338.76 262.23,334.69 233.94,339.65 C199.31,345.71 181.42,340.51 181.42,340.51 C181.42,340.51 168.83,334.56 163.79,331.85 L305.8,331.85 Z" id="_Path_35" fill="url(#linearGradient-3)"></path>
                    <g id="_Clip_Group_2" transform="translate(123.000000, 306.000000)">
                        <g id="Group">
                            <path d="M0.173576294,0.71 L242,0.71 C242,7.65221931 236.372219,13.28 229.43,13.28 L18.829487,13.28 C12.5984043,9.3703333 6.37518284,5.18141253 0.173612351,0.71000022 Z" id="Combined-Shape" fill="url(#linearGradient-4)"></path>
                            <path d="M18.829487,13.28 L213.38,13.28 C213.38,20.2222193 207.752219,25.85 200.81,25.85 L40.6891886,25.85 C33.4065621,22.0380698 26.1126546,17.849793 18.829487,13.28 Z" id="Combined-Shape" fill="url(#linearGradient-5)"></path>
                        </g>
                    </g>
...
.requirements {
  background: url('../assets/requirements-bg.jpg') no-repeat center center;
