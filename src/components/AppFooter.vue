<template>
  <div class="footer">
    <div class="container">
      <div class="row align-items-center footer__row-top">
        <div class="col-sm-12 col-md-6 footer__logo">
          <a href="#">
            <svg id="logo-footer" fill="#ffffff" width="134px" height="24px">
        ...
        <div class="col-sm-12 col-md-6 footer__nav">
          <ul class="footer__menu">
            <li class="footer__list"><a class="footer__link" v-smooth-scroll href="aboutMe">About me</a></li>
            <li class="footer__list"><a class="footer__link" v-smooth-scroll href="#relationships">Relationships</a></li>
            <li class="footer__list"><a class="footer__link" v-smooth-scroll href="#requirements">Requirements</a></li>
            <li class="footer__list"><a class="footer__link" v-smooth-scroll href="#users">Users</a></li>
            <li class="footer__list footer__list--last"><a class="footer__link" v-smooth-scroll href="#signUp">Sign Up</a></li>
          </ul>
        </div>
      </div>
      <div class="row align-items-center footer__row-center">
        <div class="col-sm-12 col-md-6 footer__contact">
          <ul class="footer__contact-menu">
            <li class="footer__contact-list">
              <svg class="footer__contact-icon" width="24px" height="18px" viewBox="0 0 24 18">
                <defs></defs>
                <g id="Page-1" stroke="none" stroke-width="1" fill-rule="evenodd">
                  <g class="footer__icon" id="mail" fill="#FFFFFF" fill-rule="nonzero">
              ...
              <a class="footer__contact-link" href="mailto:work.of.future@gmail.com">work.of.future@gmail.com</a>
            </li>
            <li class="footer__contact-list">
              <svg class="footer__contact-icon" width="20px" height="20px" viewBox="0 0 20 20">
                <defs></defs>
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g class="footer__icon" id="phone" transform="translate(-1.000000, -1.000000)" fill="#FFFFFF" fill-rule="nonzero">
              ...
              <a class="footer__contact-link" href="tel:+38 (050) 789 24 98">+38 (050) 789 24 98</a>
            </li>
            <li class="footer__contact-list footer__contact-list--last">
              <svg class="footer__contact-icon" width="16px" height="28px" viewBox="0 0 16 28">
                <defs></defs>
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g class="footer__icon" id="cellphone" transform="translate(-1.000000, -1.000000)" fill="#FFFFFF" fill-rule="nonzero">
              ...
              <a class="footer__contact-link" href="tel:+38 (095) 556 08 45">+38 (095) 556 08 45</a>
            </li>
          </ul>
        </div>
        <div class="col-sm-12 col-md-6 footer__info">
          <ul class="footer__info-menu">
            <li class="footer__info-list"><a class="footer__info-link" href="#">News</a></li>
            <li class="footer__info-list"><a class="footer__info-link" href="#">Blog</a></li>
            <li class="footer__info-list"><a class="footer__info-link" href="#">Partners</a></li>
            <li class="footer__info-list footer__info-list--last"><a class="footer__info-link" href="#">Shop</a></li>
          </ul>
          <ul class="footer__info-menu">
            <li class="footer__info-list"><a class="footer__info-link" href="#">Overview</a></li>
            <li class="footer__info-list"><a class="footer__info-link" href="#">Design</a></li>
            <li class="footer__info-list"><a class="footer__info-link" href="#">Code</a></li>
            <li class="footer__info-list footer__info-list--last"><a class="footer__info-link" href="#">Collaborate</a></li>
          </ul>
          <ul class="footer__info-menu">
            <li class="footer__info-list"><a class="footer__info-link" href="#">Tutorials</a></li>
            <li class="footer__info-list"><a class="footer__info-link" href="#">Resources</a></li>
            <li class="footer__info-list"><a class="footer__info-link" href="#">Guides</a></li>
            <li class="footer__info-list footer__info-list--last"><a class="footer__info-link" href="#">Examples</a></li>
          </ul>
          <ul class="footer__info-menu footer__info-menu--last">
            <li class="footer__info-list"><a class="footer__info-link" href="#">FAQ</a></li>
            <li class="footer__info-list"><a class="footer__info-link" href="#">Terms</a></li>
            <li class="footer__info-list"><a class="footer__info-link" href="#">Conditions</a></li>
            <li class="footer__info-list footer__info-list--last"><a class="footer__info-link" href="#">Help</a></li>
          </ul>
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col-sm-12 col-md-6 footer__copyright">
          © abz.agency specially for the test task
        </div>
        <div class="col-sm-12 col-md-6 footer__social">
          <ul class="footer__social-menu">
            <li class="footer__social-list">
              <a class="footer__social-link" href="#">
                <svg width="26px" height="26px" viewBox="0 0 26 26">
                  <defs></defs>
                  <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g class="footer__icon" id="facebook" fill="#FFFFFF" fill-rule="nonzero">
            ...
            <li class="footer__social-list">
              <a class="footer__social-link" href="#">
                <svg width="26px" height="26px" viewBox="0 0 26 26">
                  <defs></defs>
                  <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g class="footer__icon" id="linkedin" fill="#FFFFFF" fill-rule="nonzero">
            ...
            <li class="footer__social-list">
              <a class="footer__social-link" href="#">
                <svg width="26px" height="26px" viewBox="0 0 26 26">
                  <defs></defs>
                  <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="instagram" class="footer__icon" fill="#FFFFFF" fill-rule="nonzero">
            ...
            <li class="footer__social-list">
              <a class="footer__social-link" href="#">
                <svg class="footer__icon" width="26px" height="26px" viewBox="0 0 26 26">
                  <defs></defs>
                  <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="twitter" class="footer__icon" fill="#FFFFFF" fill-rule="nonzero">
            ...
            <li class="footer__social-list footer__social-list--last">
              <a class="footer__social-link" href="#">
                <svg width="26px" height="26px" viewBox="0 0 26 26">
                  <defs></defs>
                  <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g class="footer__icon" id="pinterest" fill="#FFFFFF" fill-rule="nonzero">
